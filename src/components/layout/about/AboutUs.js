...
import diegoFoto from '../../../img/DiegoLinkedIn.png'
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
            <div className="w-full text-center pb-8">
                ...
                <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-gray-900 pb-2">
                    Sección donde hablo un poco de mi.
                </h1>
                <p className="text-gray-400 font-normal text-base">Parecera trillado pero es el lugar en el que puedo comunicarme contigo</p>
            </div>
            <div className="w-full grid grid-cols-1 gap-6">
                <div className="bg-white rounded-lg p-6">
                    <div className="flex items-center space-x-6 mb-4">
                        <img className="h-28 w-28 object-cover object-center rounded-full"
                            src={diegoFoto} alt="im" />
                        <div>
                            <p className="text-xl text-gray-700 font-normal mb-1">Diego Castillo</p>
                            <p className="text-base text-blue-600 font-normal">Software Engineer</p>
                        </div>
                    </div>
                    <div>
                        <p className="text-gray-400 leading-loose font-normal text-base">Cuasi ingeniero y amante de la programacion y automatizacion de tareas, me gusta en backend tanto como el frontend aunque no me considero fullstack ya que para mi, ser full no es solo manejar el back y el front, tambien me encanta trabajar en equipo</p>
                    </div>
                </div>
            </div>
        </section>
